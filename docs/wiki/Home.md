...
Índice principal de la wiki. Fuente de verdad en el repo: `docs/wiki/` — esta copia se publica en [GitHub Wiki](https://github.com/JeansCordoba/Colombian_fruits/wiki).
...
| [Architecture](Architecture) | Resumen arquitectónico + diagramas |
